#!/usr/bin/env node
/**
 * Smoke check for provider dev server (http://localhost:8082).
 * Run when the provider app is already running (e.g. pnpm run dev:provider).
 * Usage: node tooling/expo-dev/check-provider-dev.js
 */
...
async function main() {
  console.log("Checking provider dev server at", BASE, "...");
  try {
