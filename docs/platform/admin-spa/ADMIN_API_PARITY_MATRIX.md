...
|-------|---------|-----------------------------------|
| **Inventory** | **437** admin `route.ts` handlers; full list in `docs/admin-api-route-taxonomy.csv` | Regenerate CSV when adding routes; CI blocks orphan files. |
