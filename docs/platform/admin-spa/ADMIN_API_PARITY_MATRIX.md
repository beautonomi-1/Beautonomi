...
| 109 | `/admin/commercial/terminal-insights` | W5 | commercial | Y | `GET /api/admin/commercial/terminal-insights` | **SPA:** [`TerminalInsightsPage`](../../apps/admin-web/src/routes/commercial/TerminalInsightsPage.tsx). AuthZ `ADMIN_SECTION_COMMERCIAL`, tenant via `resolveAdminApiTenantId`. |
