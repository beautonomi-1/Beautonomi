...
|-------|---------|-----------------------------------|
| **Inventory** | **422** admin `route.ts` handlers; full list in `docs/admin-api-route-taxonomy.csv` | Regenerate CSV when adding routes; CI blocks orphan files. |
...
| 102 | `/admin/provider-ops/leads/[id]` | W5 | provider_ops | N | `GET/PATCH .../leads/:id`, `PATCH .../stage`, `PATCH .../assign`, `GET/POST .../activities`, `GET/POST/PATCH/DELETE .../tasks`, `GET .../communications`, `GET .../assignable-users` | Lead detail: timeline, stage change, assignment, follow-up tasks, communications log, notes, create-account action |
