...
| 110 | `/admin/commercial/terminal-products` | W5 | commercial | Y | `GET /api/admin/commercial/terminal-products` | **SPA:** [`TerminalProductsPage`](../../apps/admin-web/src/routes/commercial/TerminalProductsPage.tsx). AuthZ `ADMIN_SECTION_COMMERCIAL`. |
| 111 | `/admin/commercial/terminal-orders` | W5 | commercial | Y | `GET /api/admin/commercial/terminal-orders` | **SPA:** [`TerminalOrdersPage`](../../apps/admin-web/src/routes/commercial/TerminalOrdersPage.tsx). AuthZ `ADMIN_SECTION_COMMERCIAL`. |
