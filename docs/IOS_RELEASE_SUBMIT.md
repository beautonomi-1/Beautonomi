...
- **Parental controls / age rating (2.3.6):** **Pre-login:** Login → **Safety & parental controls** (no account). **Post-login:** Profile tab → **Safety & parental controls** → **Parental controls — content & safety** / **Age assurance & date of birth**.
