/**
 * Country calling codes for provider mobile phone inputs.
...
/** Remove trunk prefix 0 (e.g. 082… → 82…) before appending to +country. */
...
/** Match longest country code first so +971 wins over +97 if both existed. */
...
/**
 * Initialise country picker + national field from stored DB value (E.164 or local digits).
 */
...
/** E.164 string for API / Supabase, or null if national part is empty. */
...
/** Validate a stored E.164 value (e.g. before API). Empty string is valid (optional phone). */
