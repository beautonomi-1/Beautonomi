...
/** Neutral recovery copy — no "Allow" wording (App Store 5.1.1(iv)). KEEP IN SYNC: apps/customer/src/lib/native-permissions.ts */
...
/** KEEP IN SYNC: apps/customer/src/lib/native-permissions.ts */
...
export async function openAppSettings(): Promise<void> {
  try {
    ...
    Alert.alert("Settings unavailable", "Open your device settings to manage Beautonomi Provider permissions.");
  }
}
