...
export const REPORT_DETAIL_REGISTRY: Record<string, ReportDetailDefinition> = {
  ...
  "client-retention": { title: "Client Retention", subtitle: "Repeat visit rates", apiPath: "clients/retention", query: "periodMQY" },
  "new-clients": { title: "New Clients", subtitle: "First-time customers", apiPath: "clients/new", query: "fromTo" },
  "client-lifetime-value": { title: "Lifetime Value", subtitle: "CLV and spend bands", apiPath: "clients/lifetime-value", query: "none" },
  "end-of-day": { title: "End of day", subtitle: "Daily cash-up style summary", apiPath: "end-of-day", query: "singleDate" },
  refunds: { title: "Refunds", subtitle: "Refund volume and reasons", apiPath: "payments/refunds", query: "fromTo" },
  "payment-methods": { title: "Payment Methods", subtitle: "Card, cash, wallet split", apiPath: "payments/methods", query: "fromTo" },
  payouts: { title: "Payouts", subtitle: "Provider payout history", apiPath: "payments/payouts", query: "fromTo" },
  ...
  "package-sales": { title: "Package Sales", subtitle: "Sold packages and revenue", apiPath: "packages/sales", query: "fromTo" },
