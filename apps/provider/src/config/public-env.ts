...
/** iOS App Store ID — production listing `id6748387936` (EAS `EXPO_PUBLIC_IOS_APP_STORE_ID`). */
export const IOS_APP_STORE_ID = getEnv("EXPO_PUBLIC_IOS_APP_STORE_ID") || "6748387936";
...
export function withWebApiTenantHeaders(init?: RequestInit): RequestInit {
  ...
  if (!h.has("X-App")) h.set("X-App", "provider");
