...
export function NativePermissionsOnboarding() {
  ...
  const np = (key: string, opts?: Record<string, unknown>) => t(`provider.mobile.components.nativePermissions.${key}`, opts) as string;
          ...
          {step === "welcome" && (
            <View style={{ flex: 1, paddingTop: 28 }}>
              ...
              <View style={{ marginTop: 28 }}>
                <BenefitRow text={np("benefitBookings")} />
                <BenefitRow text={np("benefitPayouts")} />
              </View>
            </View>
          )}
