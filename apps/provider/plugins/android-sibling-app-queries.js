 ...
 *   - Linking.canOpenURL("customer://") always returns false even when the
 *     Customer app is installed
 *   - Linking.openURL("customer://") silently fails
 *
 * This plugin injects:
 *   <queries>
 *     <package android:name="com.beautonomi" />
 *     <intent>
 ...
 *   </queries>
 *
 * ...so the Partner app can surface the "Open Customer app" deep link
 * reliably on all supported Android versions.
 *
 * Usage (app.config.js):
 *   plugins: [
 *     ["./plugins/android-sibling-app-queries", {
 *       packageName: "com.beautonomi",
 *       scheme: "customer",
 *     }],
 *   ]
 */
