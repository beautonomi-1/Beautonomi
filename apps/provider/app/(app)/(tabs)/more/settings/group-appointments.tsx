    ...
    <ScreenContainer>
      ...
      <View className="rounded-2xl border border-gray-100 bg-white p-4">
        <View className="flex-row items-center justify-between py-2">
          <View className="flex-1">
            <Text className="text-sm font-medium text-gray-900">Enable Group Bookings</Text>
            <Text className="text-xs text-gray-500">Allow multiple clients in one appointment</Text>
          </View>
          <Switch
        ...
        {form.enableGroupBooking && (
          <>
            ...
            <View className="flex-row items-center justify-between py-2">
              <View className="flex-1">
                <Text className="text-sm font-medium text-gray-900">Online Group Booking</Text>
                <Text className="text-xs text-gray-500">Clients can book group sessions online</Text>
              </View>
              <Switch
            ...
            <View className="py-2">
              <Text className="text-sm font-medium text-gray-900">Maximum Group Size</Text>
              <Text className="mb-2 text-xs text-gray-500">Max participants per group session</Text>
              <View className="flex-row items-center gap-3">
                ...
                <TextInput
                  className="h-10 w-16 rounded-lg border border-gray-200 bg-gray-50 text-center text-base font-semibold text-gray-900"
          ...
          <View className="rounded-2xl border border-gray-100 bg-white">
            {(locations ?? []).map((loc, i, arr) => {
              ...
              return (
                ...
                >
                  <View className="flex-1">
                    <Text className="text-sm font-medium text-gray-900">{loc.name}</Text>
                    {loc.city && <Text className="text-xs text-gray-500">{loc.city}</Text>}
                  </View>
                  <Ionicons
      ...
      {form.enableGroupBooking && (services?.length ?? 0) > 0 && (
        <>
          ...
          <Text className="mb-2 text-xs text-gray-500 px-1">
              ...
              return (
                ...
                >
                  <View className="flex-1">
                    ...
                    <Text className="text-xs text-gray-500">R{svc.price}</Text>
                  </View>
                  <Ionicons
