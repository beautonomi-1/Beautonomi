-- create_booking_with_locking (273) inserted payment_status with ::TEXT; bookings.payment_status is enum.
-- Fixes: 42804 column "payment_status" is of type payment_status but expression is of type text
