...
/**
 * Re-check staff calendar conflicts before charging (excluding this booking's own rows).
 * Returns SLOT_NO_LONGER_AVAILABLE when another booking/hold now blocks the window.
 */
