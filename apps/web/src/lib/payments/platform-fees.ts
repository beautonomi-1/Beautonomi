 ...
 *
 * @param commissionBase The commission-eligible amount (services + addons + products − discounts),
 *   EXCLUDING tip, tax, travel fee, and service fee. Pass the booking's commission base, not total.
 */
