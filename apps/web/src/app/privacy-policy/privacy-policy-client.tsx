...
import DefaultHeroImage from "../../../public/images/using-your-dashboard-optimized.jpg";
...
export default function PrivacyPolicyClient({ data }: { data: PrivacyPolicyData }) {
  const { title, description, heroImage, supplementalPolicies, articles } = data;
        ...
        >
          ...
          >
            ...
            <div className="relative w-full h-64 md:h-80 lg:h-96 rounded-2xl overflow-hidden mb-8">
              {heroImage ? (
                <Image src={heroImage} alt="Privacy Policy" fill className="object-cover" priority />
              ) : (
                <Image src={DefaultHeroImage} alt="People collaborating" fill className="object-cover" priority />
              )}
            </div>
          </motion.div>
            ...
            <div className="md:col-span-2 space-y-8">
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h2 className="text-2xl md:text-3xl font-semibold tracking-tight text-gray-900">Privacy Policy</h2>
                </div>
                <div
              ...
              >
                ...
                <p className="text-sm md:text-base font-light text-gray-600 mb-6">
                  Please review the supplemental privacy policies linked within the privacy policy documents, such as
                  for certain Beautonomi services, that may be applicable to you.
                </p>
            ...
            <div className="md:col-span-1">
              ...
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-semibold tracking-tight text-gray-900">Need to get in touch?</h3>
                </div>
                <p className="text-sm md:text-base font-light text-gray-600 mb-6">
