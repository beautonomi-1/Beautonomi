...
export interface AgeSuitabilityData {
  pageTitle: string;
  introHeading: string;
  introHtml: string;
...
export default function AgeSuitabilityClient({ data }: { data: AgeSuitabilityData }) {
  ...
  return (
    <div className="min-h-screen bg-zinc-50/50">
      <div className="w-full max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-4 md:py-6 lg:py-8">
        <BackButton href="/" />
        <Breadcrumb items={[{ label: "Home", href: "/" }, { label: "Age Suitability" }]} />
              ...
              >
                ...
                {introHtml ? (
                  ...
                  <p className="text-base md:text-lg font-light text-gray-600 mb-6 leading-relaxed">
                    This page describes minimum ages, content types, and safety controls on the Beautonomi Platform.
                  </p>
                )}
                <Link
                  href="/privacy-policy"
              ...
              >
                ...
                <div className="pt-4 border-t border-gray-200 space-y-3">
                  <p className="text-sm font-light text-gray-600">
                    In the mobile app, open <strong>Account Settings → Content &amp; Safety Controls</strong> to
                    manage restricted mode, social feed visibility, messaging, and related options.
                  </p>
