...
const NewsSection = () => {
  ...
  const newsItems = [
    {
      id: 1,
      title: t("web.home.newsInviteDiscount"),
      bgColor: "bg-[#FF0077]",
      textColor: "text-white",
      icon: <Percent className="w-8 h-8" />,
      buttonText: t("web.home.inviteFriends"),
    },
    {
      id: 2,
      title: t("web.home.newsGetBackGroove"),
          ...
          {newsItems.map((item) => (
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <h3 className="text-lg md:text-xl font-semibold flex-1 pe-2">
                  {item.title}
                </h3>
