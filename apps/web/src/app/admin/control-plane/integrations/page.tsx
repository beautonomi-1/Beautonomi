...
import { BarChart3, Map, MessageSquare, Shield, Sparkles, UserCheck } from "lucide-react";
...
const integrations = [
  ...
  { name: "Twilio", href: "/admin/settings", icon: MessageSquare, description: "SMS & WhatsApp for Provider Ops via Platform Settings" },
