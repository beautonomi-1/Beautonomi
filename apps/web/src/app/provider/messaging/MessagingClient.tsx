...
export function MessagingClient({
  ...
  const [isLoading, setIsLoading] = useState(() => {
    ...
    return !fromServer || initialConversations === null;
  });
  ...
  useEffect(() => {
    loadCurrentUser();
    if (fromServer && initialConversations !== null && !initialError) {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps -- mount bootstrap; loadConversations identity changes
  }, []);
  ...
  }, [searchParams, conversations, initialConversationId]);
