  ...
  try {
    ...
    if (!policy) {
      return handleApiError(
        ...
        "This action type has no approval policy and cannot be decided",
        "NO_POLICY",
        400,
      );
    }
    ...
    await writeAuditLog({
      ...
      action: "admin.agent_action.reject",
    ...
    return handleApiError(error as Error, "Failed to reject agent action");
  }
}
