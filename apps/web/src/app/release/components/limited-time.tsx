    ...
    <div className="container">
      <div className="mb-32">
        <div className="text-center max-w-sm mx-auto">
          <h2 className="text-[36px] font-light leading-10 text-secondary mb-3">
            Once-in-a-lifetime, for a limited time
          </h2>
          <p className="text-xl font-light text-destructive mb-10">
            See when experiences are coming up, going live, or sold out.
          </p>
        </div>
