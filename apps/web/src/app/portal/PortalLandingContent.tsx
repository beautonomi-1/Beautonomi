...
/**
 * Client content for the booking portal landing when user is not logged in
 * or when they arrived with a booking token. Used by portal/page.tsx.
 */
export default function PortalLandingContent() {
  return (
