...
export default function RisingStarCards() {
    ...
    return (
      <div className="mb-10 mt-7">
        <div className="max-w-[2340px] mx-auto px-10">
          <LoadingTimeout loadingMessage="Loading rising stars..." />
        </div>
      </div>
    );
  }
  ...
  if (providers.length === 0) {
    return (
      <div className="mb-10 mt-7">
        <div className="max-w-[2340px] mx-auto px-10">
          <EmptyState
            title="No rising stars yet"
            description="Check back later for new talent"
          />
        </div>
      </div>
    );
    ...
    <div className="mb-10 mt-7">
      <div className="max-w-[2340px] mx-auto px-10">
        <div className="flex justify-between items-center mb-5">
          <h2 className="text-2xl md:text-[32px] font-normal">Rising Star</h2>
        </div>
