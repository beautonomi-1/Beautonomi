      ...
      try {
        ...
        const errorMessage =
          err instanceof FetchTimeoutError
            ...
            ? err.message
            : "Failed to load upcoming talent";
        setError(errorMessage);
        console.error("Error loading upcoming talent:", err);
      } finally {
        setIsLoading(false);
      }
    };
    ...
    return (
      <div className="mb-10 mt-7">
        <div className="max-w-[2340px] mx-auto px-10">
          <LoadingTimeout loadingMessage="Loading upcoming talent..." />
        </div>
      </div>
    );
  }
  ...
  if (providers.length === 0) {
    return (
      <div className="mb-10 mt-7">
        <div className="max-w-[2340px] mx-auto px-10">
          <EmptyState
            title="No new providers"
            description="Check back later for upcoming talent"
          />
        </div>
      </div>
    );
    ...
    <div className="mb-10 mt-7">
      <div className="max-w-[2340px] mx-auto px-10">
        <div className="flex justify-between items-center mb-5">
          <h2 className="text-2xl md:text-[32px] font-normal">More Upcoming Talent</h2>
        </div>
