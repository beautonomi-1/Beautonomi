      ...
      try {
        ...
        const errorMessage =
          err instanceof FetchTimeoutError
            ...
            ? err.message
            : "Failed to load nearest providers";
    ...
    return (
      <div className="mb-10 mt-7">
        <div className="max-w-[2340px] mx-auto px-10">
          <LoadingTimeout loadingMessage="Loading nearest providers..." />
        </div>
      </div>
    );
  }
      ...
      <div className="mb-10 mt-7">
        <div className="max-w-[2340px] mx-auto px-10">
          <EmptyState
            ...
            description="Check back later for nearest providers"
          />
        </div>
      </div>
    );
    ...
    <div className="mb-10 mt-7">
      <div className="max-w-[2340px] mx-auto px-10">
        <div className="flex justify-between items-center mb-5">
          <h2 className="text-2xl md:text-[32px] font-normal">More Nearest Providers</h2>
        </div>
