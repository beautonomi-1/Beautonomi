...
export interface OtpDigitRowProps {
  ...
  disabled?: boolean;
  autoFocus?: boolean;
  /** Prefix for per-cell accessibilityLabel (e.g. "Login verification code"). */
...
/**
 * One-digit-per-box OTP row (parity with web `OtpDigitInput`).
 * Supports paste / iOS one-time-code autofill on the first cell.
