 ...
 * - **Recurring bookings:** `apps/web/src/app/api/recurring-bookings/route.ts` and `[id]/route.ts` — `requireAuthInApi`; rows scoped by `customer_id = user.id`. GET `[id]` returns `series_bookings` (visits with `bookings.recurring_series_id`).
 */
