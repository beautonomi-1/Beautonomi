...
export function AnalyticsProvider({ children }: { children: React.ReactNode }) {
  ...
  // Reliability: flush the queue when the app backgrounds (short sessions would otherwise drop
  // their last events) and emit a warm `app_open` when it returns to the foreground.
  useEffect(() => {
