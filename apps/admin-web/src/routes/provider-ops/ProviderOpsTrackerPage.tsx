...
interface TrackerStats { in_progress: number; stalled: number; dropped_off: number; active_in_wizard: number; slowing: number; by_step: Record<number, number>; completed: number; pending_approval: number }
    ...
    <div className="space-y-6">
      ...
      {statsQ.error ? (
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-7">
          ...
          <StatCard label="Completed" value={stats.completed} highlight={false} />
