...
export const CRITICAL_ADMIN_FLOWS: CriticalAdminFlow[] = [
  ...
  {
    id: "disputes",
    description: "Trust & Safety — dispute resolution and escalation",
    appPath: "disputes",
    pageModule: "routes/DisputesPage.tsx",
    rbac: "section",
  },
  {
    id: "refunds",
    description: "Finance — refund tracking and admin wallet refunds",
    appPath: "refunds",
    pageModule: "routes/refunds/RefundsListPage.tsx",
    rbac: "section",
  },
  {
    id: "gamification-hub",
    description: "Marketing — gamification points, badges, and ops hub",
    appPath: "gamification",
    pageModule: "routes/marketing/GamificationHubPage.tsx",
    rbac: "section",
  },
  {
    id: "system-health",
    description: "Platform — infrastructure and API monitoring (merged)",
    appPath: "system-health",
    pageModule: "routes/ops/SystemHealthPage.tsx",
    rbac: "section",
  },
  {
    id: "webhooks",
    description: "Integrations — webhook endpoints and failure retry",
    appPath: "webhooks",
    pageModule: "routes/integrations/WebhooksEndpointsPage.tsx",
    rbac: "section",
  },
  {
    ...
    pageModule: "routes/provider-ops/ProviderOpsTrackerDetailPage.tsx",
    rbac: "section",
  },
  {
    id: "provider-ops-activation",
    description: "Provider Ops — pending provider activation queue",
    appPath: "provider-ops/activation",
    pageModule: "routes/provider-ops/ProviderOpsActivationPage.tsx",
    rbac: "section",
  },
  {
    id: "provider-ops-leads",
    description: "Provider Ops — sales leads pipeline and dialer",
    appPath: "provider-ops/leads",
    pageModule: "routes/provider-ops/ProviderOpsLeadsPage.tsx",
    rbac: "section",
  },
  {
    id: "trust-safety-ops",
    description: "Trust & Safety — unified ops queue and escalations",
    appPath: "trust-safety-ops",
    pageModule: "routes/trust/TrustSafetyOpsPage.tsx",
    rbac: "section",
  },
  {
    id: "terminal-onboarding",
    description: "Commercial — Yoco terminal onboarding applications",
    appPath: "commercial/terminal-onboarding",
    pageModule: "routes/commercial/TerminalOnboardingPage.tsx",
    rbac: "section",
  },
  {
    id: "notifications-inbox",
    description: "Notifications — admin inbox with URL filter state",
    appPath: "notifications/inbox",
    pageModule: "routes/NotificationsInboxPage.tsx",
    rbac: "section",
  },
];
