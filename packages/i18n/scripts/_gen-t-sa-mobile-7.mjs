#!/usr/bin/env node
/**
 * Generate _maps/t-sa-mobile-7.json — indices 350–699 of filtered mobile-sa-missing-en.json.
 */
...
const list = missing.filter((s) => !covered[s]).slice(350, 700);
