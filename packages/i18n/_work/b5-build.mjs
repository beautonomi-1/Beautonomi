...
const { applyBatch5 } = await import("./b5-translations.mjs");
applyBatch5(r);

const arr = JSON.parse(
  fs.readFileSync(path.join(__dirname, "b5-strings.json"), "utf8"),
);
...
const dest = path.join(__dirname, "../_maps/t-sa-mobile-5.json");
