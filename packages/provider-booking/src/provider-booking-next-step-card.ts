/** Icon name — maps to lucide (web) or ionicons (mobile) in UI layers. */
export type BookingNextStepIcon =
...
): { title: string; description: string; icon: BookingNextStepIcon; color: string } {
