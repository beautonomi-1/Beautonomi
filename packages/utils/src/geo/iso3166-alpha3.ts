 ...
 * Used for Didit `expected_details.id_country` / `nationality` (alpha-3 required).
 */
export const ISO3166_ALPHA2_TO_ALPHA3: Readonly<Record<string, string>> = {
  ...
  LA: "LAO", LB: "LBN", LC: "LCA", LI: "LIE", LK: "LKR", LR: "LBR", LS: "LSO", LT: "LTU",
...
/** Convert ISO 3166-1 alpha-2 to alpha-3. Returns undefined if unmapped. */
export function alpha2ToAlpha3(code: string | null | undefined): string | undefined {
  ...
  return ISO3166_ALPHA2_TO_ALPHA3[upper];
}
